...
\[ (\Delta^*_M E)(x,y) = \left\{ 
 ...
 Donc $E$ est bien une solution de l'équation discrétisé \eqref{eigen} : $E$ correspond à une onde stationnaire associée à la valeur propre $\lambda$ pour le domaine définit par l'image.
