...
Reconnaître la forme d'un objet à partir du son qu'il émet est un problème mathématique ancien (voir \cite{kac1966can}). Il a été démontré que deux objets différents pouvaient émettre des sons identiques, la figure \ref{} en est un exemple. Cependant, dans la majorité des cas, le bruit émis est une bonne charactéristique de l'objet.
